...
/** @import { AssetInput, Domain } from "@/database/query/insert" */
 ...
 */
async function domain_tree(id_domain) {
...
domain_tree.test = function () {
	...
	if (!threw) {
		throw new Error("domain_tree.test: expected invalid input to throw");
	}
};
